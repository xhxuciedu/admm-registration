...
not apply to the assembled operator. A family of globally coefficient-frozen
...
Let $\mathcal I=[\rho_-,\rho_+]\subset(0,\infty)$. A global minimizer of
\eqref{eq:reduced_objective} over $\mathcal I$ is contained in the following
...
\eqref{eq:frozen_objective} is its exact family-wise worst contraction factor.
The finite algebraic construction of Theorem~\ref{thm:finite} applies to this
finite collection of scalar branches.
...
larger regrets, with the strongest noncommutativity cases largest in the
controlled suite. These higher regrets are consistent with increasing mismatch
between the frozen separable surrogate and the assembled noncommuting
operator. The commutator norm alone does not fully determine predictor quality. More accurate parameter selection
