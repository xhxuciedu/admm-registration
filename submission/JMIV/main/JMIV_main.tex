...
\title[Four-Corner Spectral Tuning]{Four-Corner Spectral Tuning for Quadratic ADMM with Application to Diffeomorphic Image Registration}
...
\abstract{Selecting the penalty and relaxation parameters of the alternating direction
...
\begin{align*}
\text{quadratic ADMM}&\longrightarrow\text{modal factor}\longrightarrow\text{four corners}\\
&\longrightarrow\text{finite selection}\longrightarrow\text{registration}.
\end{align*}
...
issue is reported in Online Resource~1, Section~11.2.
...
constructions are given in Online Resource~1, Sections~2--7.
...
Online Resource~1, Section~10.2.
...
parameters are specified in Online Resource~1, Section~9.2.
...
Online Resource~1, Section~12; baseline safeguards and certificate protocols are in
Online Resource~1, Sections~10 and~9, respectively.
...
Extended methods, proofs, certificate constructions, and additional experiments are provided in Online Resource~1.
